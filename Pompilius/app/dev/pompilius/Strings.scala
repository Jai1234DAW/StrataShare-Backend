...
object Strings {
  ...
  val area = "area"
  val authorizedUsers= "authorizedUsers"
  val authors = "authors"
  ...
  val baseUrl = "baseUrl"
  val baseUrlAppDeployment="baseUrlAppDeployment"
  val bio = "bio"
  val buyerId = "buyerId"
  ...
  val userTypeRelation="userTypeRelation"
  val useSSL = "useSSL"
  val valid = "valid"
