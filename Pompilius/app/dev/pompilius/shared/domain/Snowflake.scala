...
trait Snowflake {
  ...
  //  Preguntar aqui, porque al no tener nodo se le puede colocar un número aleatorio, o un número fijo, o un número basado en la hora, etc. Lo importante es que sea único para cada instancia de la aplicación.
