...
//import dev.pompilius.study.domain.{StudyId, StudyRepository}
...
//            resourceId = ResourceId.gen(configuration.nodeId),
...
//            sampleId = SampleId.gen(configuration.nodeId),
...
//          // 1. Crear el Resource
//          val newResource = Resource(
//            Reid = ResourceId.gen(configuration.nodeId),
